...
Welcome to **EviNx FileShare** 🧠  
Here you can find and download all shared projects.  
Each project has its own folder and download page.
...
|  3  | 🧩 Hoi4Mods       | [Open Folder →](https://github.com/Envika/EviNx_FileShare/tree/main/Hoi4Mods)         |

---

### 💡 How it Works

1. Choose your desired project from above.
2. It opens a folder with its **own README** and file list.
3. Inside that page you’ll find all **download links** and extraction instructions.

---

### 🧰 Tools Recommended

- [7‑Zip](https://www.7-zip.org/https://soft98.ir/software/compress/22-7zip-2-dl.html/) – for split archives
